					...
					<div class="well">
						...
						<form:form action="dang-ky" method="POST" modelAttribute="user">  
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="display_name" class="span3" placeholder="Mời nhập họ và tên" path="display_name" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputAddress">Địa chỉ</label>
								<div class="controls">
									<form:input type="address" class="span3" placeholder="Mời nhập địa chỉ" path="address" />
								</div>
							</div>
							<div class="controls">
