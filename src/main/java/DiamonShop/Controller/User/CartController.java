...
public class CartController extends BaseController {
	...
	public String CheckOutBill(HttpServletRequest request,HttpSession session,@ModelAttribute("bills") Bills bill) {
		bill.setQuanty(Integer.parseInt(String.valueOf(session.getAttribute("TotalQuantyCart"))));
		bill.setTotal(Double.parseDouble(String.valueOf(session.getAttribute("TotalPriceCart"))));
